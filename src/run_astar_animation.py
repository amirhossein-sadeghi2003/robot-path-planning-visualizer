...
from search_algorithms import SearchStep, astar_search
...
def draw_frame(grid, step, output_path, frame_number, total_frames, phase_name):
    ...
    title = f"A* {phase_name} - Frame {frame_number}/{total_frames}"
    ax.set_title(title)
...
def main():
    ...
    frame_dir = output_dir / "astar_frames"
    ...
    gif_path = output_dir / "astar_search.gif"
