...
from search_algorithms import SearchStep, dijkstra_search
...
def draw_frame(grid, step, output_path, frame_number, total_frames, phase_name):
    ...
    title = f"Dijkstra {phase_name} - Frame {frame_number}/{total_frames}"
    ax.set_title(title)
...
def main():
    ...
    frame_dir = output_dir / "dijkstra_frames"
    ...
    gif_path = output_dir / "dijkstra_search.gif"
