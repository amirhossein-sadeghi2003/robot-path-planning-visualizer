...
from search_algorithms import SearchStep, dijkstra_weighted_search
...
def draw_frame(weighted_grid, step, output_path, frame_number, total_frames, phase_name):
    ...
    title = f"Weighted Dijkstra {phase_name} - Frame {frame_number}/{total_frames}"
    ax.set_title(title)
...
def main():
    ...
    steps = dijkstra_weighted_search(weighted_grid)
    ...
    frame_dir = output_dir / "weighted_dijkstra_frames"
    ...
    gif_path = output_dir / "weighted_dijkstra_search.gif"
