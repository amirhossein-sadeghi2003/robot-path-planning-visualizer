...
from search_algorithms import dijkstra_weighted_search
...
def draw_search_step(weighted_grid, step, output_path):
    ...
    ax.set_title("Weighted Dijkstra Search Visualization")
...
def main():
    ...
    draw_search_step(
        ...
        step=final_step,
        output_path="results/weighted_dijkstra_search_preview.png",
    )

    print("Saved: results/weighted_dijkstra_search_preview.png")
